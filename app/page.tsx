...
const rules = {
  ...
  one: { label: "Jednostranný potisk", percent: 25, minimum: 35 },
  two: { label: "Oboustranný potisk", percent: 40, minimum: 50 },
  three: { label: "Trojstranný potisk", percent: 50, minimum: 60 },
};
